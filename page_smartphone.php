    ...
    <div class="row no-gutters products">
      <div class="col-6 col-md-6 col-lg-6 border-top">
        <a href="shop-single.html" class="item">
          <img src="<?php echo get_template_directory_uri(); ?>/images/product_1.jpg" alt="Image" class="img-fluid">
          <div class="item-info">
            <h3>The Shoe</h3>
      ...
      <div class="col-6 col-md-6 col-lg-6 border-top">
        <a href="shop-single.html" class="item">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/images/product_2.jpg" alt="Image" class="img-fluid">
          <div class="item-info">
      ...
      <div class="col-6 col-md-6 col-lg-6">
        <a href="shop-single.html" class="item">
          <img src="<?php echo get_template_directory_uri(); ?>/images/product_3.jpg" alt="Image" class="img-fluid">
          <div class="item-info">
            <h3>The  Belt</h3>
            <span class="collection d-block">Summer Collection</span>
            <strong class="price">$9.50</strong>
